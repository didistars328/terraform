...
# service
resource "aws_iam_role" "elastic-beanstalk-service-role" {
...
resource "aws_iam_policy_attachment" "app-attach-elastic-beanstalk" {
  name       = "app-attach-elastic-beanstalk"
  roles      = [aws_iam_role.elastic-beanstalk-service-role.name]
